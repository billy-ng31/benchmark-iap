...
WEIGHT_DISTANCE = 0                 # Phạt dựa trên tổng khoảng cách di chuyển
...
WEIGHT_CONSECUTIVE_SHIFTS = 0       # Phạt nếu 2 ca xếp quá gần nhau (thời gian nghỉ ngắn)
WEIGHT_AGE_PRIORITY = 4             # Phạt nếu xếp nhiều ca cho người lớn tuổi (>45 tuổi)
